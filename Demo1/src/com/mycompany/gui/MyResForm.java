 ...
 * @author Mechlaoui
 */
public class MyResForm extends BaseForm {
        public MyResForm(Resources res) {
        super(BoxLayout.y());
        ...
        RadioButton elements = RadioButton.createToggle("Mes reservation", barGroup);
        ...
        ArrayList<Evenement> events = ServicesEvenement.myResEvent(String.valueOf(SessionManager.getId()));
        if(events != null){
   ...
   private Container addButton(Image img, String title,int id) {
       ...
       Button details = new Button("Annuler");
       ...
       image.addActionListener(e -> {
           ...
           ServicesEvenement.annulerRes(String.valueOf(SessionManager.getId()), String.valueOf(id));
           Dialog.show("Succès", "Reservation annulé avec succès", "Ok", null);
           refreshTheme();
               });
       return cnt;
   }
