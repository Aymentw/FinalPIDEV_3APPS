 ...
 * @author Mechlaoui
 */
public class DeleteDocForm extends BaseForm {

    public DeleteDocForm(Resources res, Document ev) {
        super(BoxLayout.y());
    ...
    private void addTab(Tabs swipe, Image img, String text, Document ev) {
        ...
        reserver.addActionListener((booking) -> {
            ...
            res.addActionListener((bookin) -> {
                ...
                sd.supprimerDoc(ev.getId());
                dlg.dispose();
                AffichageLDocForm att = new AffichageLDocForm(Resources.getGlobalResources());
                att.show();
            });
