...
public class SignUpForm extends BaseForm {
    ...
    public SignUpForm(Resources res) {
        ...
        niveau = new ComboBox<>(VectorNiveau);
        ...
        next.addActionListener((register) -> {
                ...
                req.addArgument("niveau", niveau.getSelectedItem());
        ...
        //fda59afbe09f1dedbc70bfddd135618e
         fb.addActionListener((e) -> {
            String clientId = "399189543881959";
            String redirectURI = "https://www.google.fr/";
            String clientSecret = "0ac3ed586c4348e78c8234050313c21d";
