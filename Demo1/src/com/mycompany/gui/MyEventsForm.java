 ...
 * @author Mechlaoui
 */
public class MyEventsForm extends BaseForm{

    public MyEventsForm(Resources res) {
        super(BoxLayout.y());
        ...
        ArrayList<Evenement> list = ServicesEvenement.CurrentGreater();
        if (list !=null ){
            ...
            addTab(swipe,res.getImage("noEvents.png"), "Il n'y a pas d'événements pour cette semaine");
        }        
        ...
        RadioButton elements = RadioButton.createToggle("Mes événements", barGroup);
        ...
        ArrayList<Evenement> events = ServicesEvenement.myEvents(String.valueOf(SessionManager.getId()));
