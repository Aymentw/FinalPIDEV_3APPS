...
public class EditEventForm extends BaseForm {
    ...
    public EditEventForm(Resources res,Evenement edit_ev) {
        super(BoxLayout.y());
       ...
       //pp.setIcon(pap);
        ...
        nomEvent.setText(edit_ev.getNom());
        ...
        typeEvent.setSelectedString(edit_ev.getType().name());
        ...
        typeResEvent.setSelectedString(edit_ev.getType_Reservation().name());
        typeResEvent.setStrings("Payante", "Gratuite");
        addStringValue("Type Reservation", typeResEvent);
        
        TextField PrixEvent = new TextField("");
        if(edit_ev.getPrix()!= 0){
            PrixEvent.setText(String.valueOf(edit_ev.getPrix()));
        }
        ...
        dateEvent.setDate(edit_ev.getDate_Event());
        ...
        v.addConstraint(nomEvent, new LengthConstraint(1)).
            addConstraint(PrixEvent, new RegexConstraint("^\\d{1,10}$","Veuillez choisir un prix valide")).
        ...
        ajout.addActionListener((edit)-> {
            Date dateTime = edit_ev.getDate_Event();
            String prix;
            ...
            Evenement newEvent = new Evenement(edit_ev.getID(),SessionManager.getId(),
                                               nomEvent.getText(),
                                               ...
                                               descEvent.getText(),path.getText(),Evenement.EtatEvent.Oui,Integer.valueOf(prix));
                System.out.println(prix);
                System.out.println(nomEvent.getText());
                System.out.println(quota);
            ServicesEvenement.editEvent(newEvent,path.getText(),java_date);
